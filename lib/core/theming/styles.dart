...
class TextStyles {
  ...
  static TextStyle font8MediumWhite = TextStyle(
    fontSize: 10.sp,
    fontWeight: FontWeightHelper.medium,
    color: Colors.white,
  );

  static TextStyle font11MediumGrey = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.grey,
  );

  static TextStyle font12RegularBlue = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.mainBlue,
  );
  ...
  static TextStyle font14RegularInactiveGrey = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.inactiveGrey,
  );
  ...
  static TextStyle font16MediumDarkBlue = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.darkBlue,
  );

  static TextStyle font16BoldDarkBlue = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.darkBlue,
  );
  ...
  static TextStyle font20MediumDarkBlue = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.darkBlue,
  );
  ...
  static TextStyle font10RegularDarkBlue = TextStyle(
    fontSize: 10.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.darkBlue,
  );

  static TextStyle font12MediumWhite = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.medium,
    color: Colors.white,
  );

  static TextStyle font12MediumBlue = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.mainBlue,
  );

  static TextStyle font12MediumLightGrey = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.lightGrey,
  );

  static TextStyle font14MediumLightGrey = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.lightGrey,
  );
  ...
  static TextStyle font14SemiBoldDarkBlue = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.darkBlue,
  );

  static TextStyle font16SemiBoldDarkBlue = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.darkBlue,
  );
  ...
  static TextStyle font18SemiBoldNearBlack = TextStyle(
    fontSize: 18.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.nearBlack,
  );

  static TextStyle font12MediumTextSecondary = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.medium,
